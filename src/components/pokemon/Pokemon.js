...
export default class pokemon extends Component {
    // Définition des états qui vont stocker les différentes datas
    state = {
        name: '',
        pokemonIndex: '',
        imageUrl: '',
    ...
    async componentDidMount() {
        ...
        // URLS pour les infos des pokemon
        ...
        // Récupération de l'image du pokemon concerné par le lien
        ...
        // Converte hectogrames to pounds. [LBS]
        const weight = 
            Math.round((pokemonRes.data.weight * 0.220432 + 0.0001) * 100) /100;
        ...
        await axios.get(pokemonSpeciesUrl).then(res => {
            ...
            // Mise à jours de états afin de réucpérer les infos
            this.setState({
                description,
                genderRatioFemale,
                genderRatioMale,
        ...
        // Mise à jour des objets qui vont être remplie avec la méthode GET.
        this.setState({
            imageUrl,
            pokemonIndex,
            name,
                    ...
                    <div className="row align-items-center">
                            <div className="col-md-3">
                                <img
                                    ...
                                    className="card-img-top rounded mw-auto mt-2"
                                    />
                            </div>
